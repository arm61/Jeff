...
"""
function arbitrary_smearing(q::Array{Float64, 1}, w::Array{Float64, 2}, resolution; nsamples::Int64=500, scale::Float64=1., bkg::Float64=0.)
    smeared_output = zeros(Float64, size(q, 1))
    for i = 1:size(q, 1)
